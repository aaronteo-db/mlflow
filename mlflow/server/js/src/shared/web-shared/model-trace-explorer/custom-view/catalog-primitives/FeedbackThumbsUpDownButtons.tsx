 ...
 * the data model (via the bound `value` path) AND dispatches an A2UI client
 * action so the host can persist it as an MLflow feedback assessment.
 */
export const FeedbackThumbsUpDownButtonsApi = {
...
export const FeedbackThumbsUpDownButtons = createComponentImplementation(
